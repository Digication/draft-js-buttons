  ...
  return function (_Component) {
    ...
    _createClass(BlockStyleButton, [{
      ...
      value: function render() {
        ...
        var buttonClass = customClass ? (0, _unionClassNames2.default)(theme.button, customClass) : theme.button;
        var className = this.blockTypeIsActive() ? (0, _unionClassNames2.default)(buttonClass, theme.active) : buttonClass;
